...
## Overview
Это приложение является образовательным проектом и было создано как прототип реального отпугивателя животных и людей, представляющего опасность для вашей жизни и здоровья.

Суть этой идеи заключается в создании звуков, которые могут отпугнуть определенные виды опасностей, которые в этом приложении разделены на группы (см. присеры ниже).
